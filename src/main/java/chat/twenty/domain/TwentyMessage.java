...
public class TwentyMessage {
     ...
     * 일반채팅 생성자
     */
    public TwentyMessage(Long roomId, Long userId, ChatMessageType type, String content) {
        this.roomId = roomId;
        this.userId = userId;
        this.type = type;
     ...
     * GPT 옵션 활성화 채팅 생성자
     */
    public TwentyMessage(Long roomId, Long userId, ChatMessageType type, String username, String content, boolean isGptChat, String gptUuid) {
        this.roomId = roomId;
        this.userId = userId;
