...
public enum GptPrompt {
    ...
    TWENTY_PROMPT("You are gonna be play 'Twenty questions game' with users." +
            ...
            "When one of users guesses correct 'answer of game', your reply has to contain '##' identifier to determine winner." +
    ...
    public String setSubject(String subject) {
        ...
        return this.prompt.replace("@", subject);
    }
